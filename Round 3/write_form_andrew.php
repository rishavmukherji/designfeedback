...
<a href="$http://www.success-equation.com/" target="_blank">The Success Equation (www.success-equation.com)</a></div>
...
Who is the publisher for The Success Equation?: <input class="answer" id="v1" name="v1" type="text" /><br />
What email address should send any questions or feedback relating to the site to?: <input class="answer" id="v2" name="v2" type="text" /><br />
If player 1 has a 51% chance of winning one point, what is the probability they will win a five set match (use the tennis simulation page)?: <input class="answer" id="v4" name="v4" type="text" /><br />
<br />
<br />
&nbsp;</div>
<hr/>
