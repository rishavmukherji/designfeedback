...
<a href="$http://www.harvardcricket.org/" target="_blank">The Harvard Cricket Club (www.harvardcricket.org) </a></div>
...
Who is the faculty advisor of the Harvard Cricket Club?: <input class="answer" id="v1" name="v1" type="text" /><br />
How many people are listed in the alumni section of the club?: <input class="answer" id="v2" name="v2" type="text" /><br />
Who scored more runs in the Harvard vs UPenn game on Saturday, Sep 21?: <input class="answer" id="v4" name="v4" type="text" /><br />
<br />
<br />
&nbsp;</div>
<hr/>
...
<?php
$file = file_get_contents('cricket_comments.txt', FILE_USE_INCLUDE_PATH);
// echo $file;
$arr = explode("\n", $file);
// var_dump($arr);
$count = 0;
